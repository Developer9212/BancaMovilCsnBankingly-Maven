...
public abstract class FacadeLoan<T> {
        ...
        try {
            ...
            for (Object[] lista_pagos : lista_objetos) {
                ...
                if (aux_d.getCargoabono() == 1) {
                    ...
                    converted = String.valueOf(convertToLocalDateTimeViaInstant(ts) + ":00");
    ...
    public LoanFee nextFee(int o, int p, int a) {
        ...
        try {
            ...
            Query RsSai = em.createNativeQuery(sai_auxiliar);
            String sai = RsSai.getSingleResult().toString();
            System.out.println("Resultado del sai_auxiliar del proxima cuota:"+sai);
            String[] parts = sai.split("\\|");
            ...
            if (posiciones_sai.get(13).toString().equals("C")) {
                ...
                String consultaA = "SELECT * FROM amortizaciones WHERE idorigenp=" + o
                        + " AND idproducto=" + p
                        + " AND idauxiliar=" + a
                        + " AND todopag=false order by vence asc limit 1";//'" + posiciones_sai.get(10) + "' limit 1";
                System.out.println("Consulta proxima amortizacion:"+consultaA);
            ...
            try {
                ...
                System.out.println("Error al ejecutar cadena de prestamo cuanto:"+e.getMessage());
            }
