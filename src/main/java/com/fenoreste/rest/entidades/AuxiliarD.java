...
public class AuxiliarD implements Serializable {
    ...
    @EmbeddedId
    protected AuxiliarDPk auxiliaresDPK;
    ...
    public AuxiliarD(AuxiliarDPk auxiliaresDPK) {
        this.auxiliaresDPK = auxiliaresDPK;
    }

    public AuxiliarD(int idorigenp, int idproducto, int idauxiliar, Date fecha) {
        this.auxiliaresDPK = new AuxiliarDPk(idorigenp, idproducto, idauxiliar, fecha);
    }

    public AuxiliarDPk getAuxiliaresDPK() {
        return auxiliaresDPK;
    }

    public void setAuxiliaresDPK(AuxiliarDPk auxiliaresDPK) {
        this.auxiliaresDPK = auxiliaresDPK;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AuxiliarD)) {
            return false;
        }
        AuxiliarD other = (AuxiliarD) object;
