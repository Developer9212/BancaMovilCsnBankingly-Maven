...
public class UsuarioBanca implements Serializable {
    ...
    public UsuarioBanca(PersonasPK personasPK, String alias_usuario, int idorigenp, int idproducto, int idauxiliar, boolean estatus) {
