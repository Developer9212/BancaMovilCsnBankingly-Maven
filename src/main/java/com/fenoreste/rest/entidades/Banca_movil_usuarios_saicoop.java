...
public class Banca_movil_usuarios_saicoop implements Serializable {
    ...
    public Banca_movil_usuarios_saicoop() {
    
    }

    public Banca_movil_usuarios_saicoop(PersonasPK personasPK, String alias_usuario, int idorigenp, int idproducto, int idauxiliar, boolean estatus) {
