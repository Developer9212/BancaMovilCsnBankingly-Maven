...
@Cacheable(false)
@Embeddable
public class AuxiliarDPk implements Serializable {
    ...
    public AuxiliarDPk(int idorigenp, int idproducto, int idauxiliar, Date fecha) {
    ...
    public AuxiliarDPk(int idorigenp, int idproducto, int idauxiliar) {
        this.idorigenp = idorigenp;
        this.idproducto = idproducto;
        this.idauxiliar = idauxiliar;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AuxiliarDPk)) {
            return false;
        }
        AuxiliarDPk other = (AuxiliarDPk) object;
