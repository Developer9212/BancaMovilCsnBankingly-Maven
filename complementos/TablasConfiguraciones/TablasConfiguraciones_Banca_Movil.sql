...
DROP TABLE IF EXISTS banca_movil_usuarios_bankingly;
    ...
    drop trigger if exists t_iu_banca_movil_usuarios_bankingly on banca_movil_usuarios_bankingly;
    create or replace function t_iu_banca_movil_usuarios_bankingly() returns trigger as $$
...
create trigger t_iu_banca_movil_usuarios_bankingly
before         insert or update
on             banca_movil_usuarios_bankingly
for each row   execute procedure t_iu_banca_movil_usuarios_bankingly();
...
DROP TABLE IF EXISTS movimientos_entrada_bankingly;
CREATE TABLE movimientos_entrada_bankingly(
 ...
 debitproducttypeid                    integer,
 debitcurrencyid                       text   ,
 creditproductbankidentifier           text   ,
 creditproducttypeid                   integer,
 amount                                numeric,
