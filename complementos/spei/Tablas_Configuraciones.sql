...
/*===================Cuenta contable para SPEI aqui solo va el abono del monto principal que se esta trasnfiriendo de la tdd:Aplicado======================*/
INSERT INTO tablas(idtabla,idelemento,dato1)VALUES('bankingly_banca_movil','cuenta_spei','20407160101068');

/*====================Cuenta contable para comisiones==================================================*/
...
/*====================Cuenta contable para comisiones==================================================*/
INSERT INTO tablas(idtabla,idelemento,dato1,dato2)VALUES('bankingly_banca_movil','cuenta_spei_comisiones_iva','20407090101004','0.80');
...
/*Path para actualizar el estatus de una orden SPEI*/
DELETE FROM tablas WHERE idtabla='bankingly_banca_movil' AND idelemento='ejecuta_orden_spei';
INSERT INTO tablas(idtabla,idelemento,nombre,dato2)VALUES('bankingly_banca_movil','ejecuta_orden_spei','actualizar el estado de una orden spei','http://192.168.99.37:8080/Banca-Jersey/services/Transaction/ejecutaSpei');

/*Path para actualizar el registro de una clabe spei*/
DELETE FROM tablas WHERE idtabla='bankingly_banca_movil' AND idelemento='notifica_estado_cuenta_spei';
INSERT INTO tablas(idtabla,idelemento,nombre,dato2)VALUES('bankingly_banca_movil','notifica_estado_cuenta_spei','actualizar el registro de una cuenta spei','http://192.168.99.37:8080/Banca-Jersey/services/Clients/notificaEstadoCuenta/');

/*Path para registrar una cuenta SPEI en STP White List*/
DELETE FROM tablas WHERE idtabla='bankingly_banca_movil' AND idelemento='registra_cuenta_spei';
INSERT INTO tablas(idtabla,idelemento,nombre,dato2)VALUES('bankingly_banca_movil','registra_cuenta_spei','registrar una cuenta spei white list','http://192.168.99.37:8080/SPEI-CSN/spei/v1.0/registraCuentaPersonaFisica');

/*Usuario para SPEI salida*/
DELETE FROM tablas WHERE idtabla='bankingly_banca_movil' AND idelemento='usuario_spei';
INSERT INTO tablas(idtabla,idelemento,dato1)VALUES('bankingly_banca_movil','usuario_spei','1111');

/*Montos maximo para spei*/
...
/*Horario y dias activos para uso SPEI*/
...
/*Activa,desactiva uso ws registra cuentas persona fisica*/
